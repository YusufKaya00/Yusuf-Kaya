        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              AWS tabanlı bulut görüntü işleme ve otomatik yeniden boyutlandırma servisi
            </p>
          </motion.div>
            ...
            >
              <div className="glass-strong rounded-2xl p-8 border border-white/10">
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed">
                  <p>
                    Cloud Photo Resize, AWS Lambda ve S3 servislerini kullanarak tamamen sunucusuz (serverless) bir görüntü işleme çözümüdür. Kullanıcılar tarafından yüklenen fotoğraflar otomatik olarak farklı boyutlarda optimize edilir ve CDN üzerinden hızlıca sunulur.
                  </p>
                  <p>
                    Sistem, yüksek ölçeklenebilirlik, düşük maliyet ve minimum bakım gereksinimleri ile binlerce eşzamanlı görüntü işleme talebini karşılayabilir. Event-driven mimari sayesinde gerçek zamanlı işleme garantisi sağlar.
                  </p>
                </div>
              </div>
              ...
              <div className="glass-strong rounded-2xl p-8 border border-white/10">
                ...
                <ul className="space-y-3 text-gray-300">
                  {[
                    'AWS Lambda ile serverless mimari',
                    'S3 event-triggered otomatik işleme',
                    'Çoklu boyut ve format desteği (thumbnail, medium, large)',
                    'CloudFront CDN entegrasyonu',
                    'Otomatik görüntü optimizasyonu ve sıkıştırma',
                    'Metadata koruma (EXIF bilgileri)',
                    'Maliyet optimizasyonlu depolama (S3 lifecycle)'
                  ].map((feature, index) => (
                    <motion.li
                      key={index}
            ...
            >
              ...
              <div className="glass-strong rounded-2xl p-6 border border-white/10">
                ...
                <div className="glass rounded-xl p-4 border border-green-500/30">
                  <p className="text-green-300 font-medium mb-2">Prodüksiyonda</p>
                  ...
                  <p className="text-xs text-gray-400 mt-2">Aktif olarak kullanılıyor</p>
                </div>
              </div>
              ...
              <div className="glass-strong rounded-2xl p-6 border border-white/10">
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <span className="text-gray-300 text-sm group-hover:text-white transition-colors">AWS Dökümantasyon</span>
                    <svg className="w-4 h-4 ml-auto text-gray-500 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </a>
