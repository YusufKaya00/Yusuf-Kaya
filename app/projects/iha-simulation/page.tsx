        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div
              ...
              className="inline-block px-4 py-2 rounded-full glass border border-teal-500/30 mb-4"
            >
              <span className="text-teal-400 text-sm font-medium">Flight Simulation</span>
            </motion.div>
