        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Mission Planner ile entegre İnsansız Hava Aracı otomasyon arayüzü
            </p>
          </motion.div>
            ...
            >
              <div className="glass-strong rounded-2xl p-8 border border-white/10">
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed">
                  <p>
                    İnsansız Hava Aracı (İHA) kontrol arayüzü, Mission Planner ile tam entegre çalışan gelişmiş bir otomasyon sistemidir. Gerçek zamanlı veri aktarımı, otomatik görev planlama ve telemetri analizi özellikleri sunar.
                  </p>
                  <p>
                    Sistem, MAVLink protokolü üzerinden iletişim kurarak uçuş verilerini işler, waypoint navigasyonu sağlar ve güvenli uçuş operasyonları için kritik alarmlar verir.
                  </p>
                </div>
              </div>
              ...
              <div className="glass-strong rounded-2xl p-8 border border-white/10">
                ...
                <ul className="space-y-3 text-gray-300">
                  {[
                    'MAVLink protokolü ile gerçek zamanlı veri iletişimi',
                    'Otomatik görev planlama ve yürütme',
                    'GPS waypoint navigasyonu',
                    'Telemetri verilerinin görselleştirilmesi',
                    'Video stream entegrasyonu',
                    'Acil durum yönetim sistemi',
                    'Çoklu İHA kontrol desteği'
                  ].map((feature, index) => (
                    <motion.li
                      key={index}
            ...
            >
              ...
              <div className="glass-strong rounded-2xl p-6 border border-white/10">
                ...
                <div className="glass rounded-xl p-4 border border-green-500/30">
                  <p className="text-green-300 font-medium mb-2">Aktif Kullanımda</p>
                  ...
                  <p className="text-xs text-gray-400 mt-2">Üretim ortamında çalışıyor</p>
                </div>
              </div>
